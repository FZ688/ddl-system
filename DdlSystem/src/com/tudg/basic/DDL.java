...
import com.tudg.bean.Admin;
import com.tudg.bean.Homework;
import com.tudg.bean.Manage;
import com.tudg.bean.User;
...
public class DDL {
    ...
    private void deleteUser(){
        ...
        if(user ==null){
            ...
            System.out.println("查询成功~");
            System.out.println("请问您确定要删除该用户吗?  y/n");
    ...
    private void manage_UpadatePassWord(User user){
        ...
        if(user.getUserPassWord().equals(passWord)){
            ...
            System.out.println("您输入的原密码有误，请重试~");
        }
